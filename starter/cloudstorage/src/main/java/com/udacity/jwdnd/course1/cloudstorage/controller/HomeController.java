...
public class HomeController {
    ...
    public String getHomePage(Model model, Authentication authentication){
        ...
        model.addAttribute("fileList", fileService.getCreatedFiles(user.getUserId()));
        return "home";
    }

//    @PostMapping
//    public String sendingData(Authentication authentication, FileForm fileForm, NoteForm noteForm, Model model, User user){
